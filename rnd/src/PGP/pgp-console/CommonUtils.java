...
public class CommonUtils {
    ...
    /**
     * Copies "length" amount of data from the input stream and writes it as PGP literal data to the provided output stream
     *
    ...
    /**
     * Extracts a PGP public key from a given key ring.
     *
     * @param pgpPublicKeyRing the public key ring
