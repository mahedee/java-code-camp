...
public class PgpEncryptionTest {
    ...
    // Mahedee: temporary folder to store encrypted and decrypted file
    ...
    private static final String passkey = "strong-passphrase";
    ...
    private final URL testFile = loadResource("/PlainFile.txt");
